...
export class RankingsComponent implements OnInit {
  ...
  topSilver: any[] 
  topTrophy: any[]
  topMix: any[]  // NUEVO: ranking de Mix
  topInfinite: any[]
  rankings: Ranking[]
    ...
    this.userService.getTops().subscribe({
      next: (results:any) => {
        this.rankings = [
          ...
          { tabName: "Mix Scores", cardText: "Top Mix scores", img: "assets/images/mix.png", imgDes: "Mix Image", ranking: results.mix }  // NUEVO: Añadir ranking de Mix
        ]
